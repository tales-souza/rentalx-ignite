...
let Rental = (_dec = (0, _typeorm.Entity)("rentals"), _dec2 = (0, _typeorm.PrimaryColumn)(), _dec3 = (0, _typeorm.ManyToOne)(() => _Car.Car), _dec4 = (0, _typeorm.JoinColumn)({
  name: "car_id"
}), _dec5 = (0, _typeorm.Column)(), _dec6 = (0, _typeorm.Column)(), _dec7 = (0, _typeorm.Column)(), _dec8 = (0, _typeorm.Column)(), _dec9 = (0, _typeorm.Column)(), _dec10 = (0, _typeorm.Column)(), _dec11 = (0, _typeorm.CreateDateColumn)(), _dec12 = (0, _typeorm.UpdateDateColumn)(), _dec(_class = (_class2 = class Rental {
  constructor() {
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "car", [_dec3, _dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "car_id", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "user_id", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "start_date", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "end_date", [_dec8], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "expected_return_date", [_dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "total", [_dec10], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
