...
let UserTokens = (_dec = (0, _typeorm.Entity)("users_tokens"), _dec2 = (0, _typeorm.PrimaryColumn)(), _dec3 = (0, _typeorm.Column)(), _dec4 = (0, _typeorm.Column)(), _dec5 = (0, _typeorm.ManyToOne)(() => _User.User), _dec6 = (0, _typeorm.JoinColumn)({
  name: "user_id"
}), _dec7 = (0, _typeorm.Column)(), _dec8 = (0, _typeorm.CreateDateColumn)(), _dec(_class = (_class2 = class UserTokens {
  constructor() {
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "refresh_token", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "user_id", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "expires_date", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
